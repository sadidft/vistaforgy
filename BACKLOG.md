...
| Area | Detail |
|---|---|
| **Skill tree** | **136 node** — Tier 0 (31), Tier 1 (24), Tier 2 (15), Tier 3 (22), Tier 4 (33), Universal (6+5). v1.3: simpleks pivot (steps + tableau), sensitivitas c₁, goal programming, branch & bound (IP) |
...
| **Test** | **13.620 assertion engine 0 gagal + E2E browser nyata 18/18** | (`node tests/run.js`) — 121 generator × validasi, scheduler, gerbang, kripto roundtrip + tamper, merge, storage |
